...
/* Mult setting for USB 3.0. Set to 1 for compliance test support. */
#define CY_FX_EP_ISO_VIDEO_SS_MULT     (1)

/* Burst setting for USB 3.0. Set to burst of 3 KB. */
#define CY_FX_EP_ISO_VIDEO_SS_BURST    (3)
